  ...
  return (
    <div className={`${getRootClass()} ${themeClasses.pageBackground} transition-colors duration-300 -mt-16`}>
      ...
      <section className={getSectionClass()}>
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 relative z-10">
          <div className="text-center">
            ...
            <h1 className={`text-6xl md:text-7xl lg:text-8xl font-bold ${themeClasses.textPrimary} mb-6 leading-tight animate-slide-up`}>
              ...
              <br />
              <span className={`${theme === 'aloof' ? 'aloof-accent-text' : `${themeClasses.gradient} bg-clip-text text-transparent`} animate-gradient-shift bg-200`}>
                with AI!
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <Link 
                to="/predict" 
                className={`group w-full sm:w-auto px-8 py-4 ${theme === 'aloof' ? 'aloof-cta-primary' : `${themeClasses.buttonPrimary}`} font-semibold rounded-xl shadow-lg hover:shadow-xl dark:shadow-glow dark:hover:shadow-glow-lg transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2`}
              >
                Start Free Analysis
              ...
              <Link 
                to="/domains" 
                className={`w-full sm:w-auto px-8 py-4 ${theme === 'aloof' ? 'aloof-cta-secondary' : `${themeClasses.cardBackground} backdrop-blur-md border-2 ${themeClasses.border} ${themeClasses.hover} ${themeClasses.textPrimary}`} font-semibold rounded-xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 shadow-sm hover:shadow-md`}>
                Explore Domains
              </Link>
            </div>
            ...
            <div className="mt-16 grid grid-cols-3 gap-8 max-w-3xl mx-auto">
              <div className={`text-center p-4 ${themeClasses.cardBackground} backdrop-blur-sm rounded-xl border ${themeClasses.border}`}>
                <div className={`${theme === 'aloof' ? 'aloof-stat-number text-3xl font-bold' : `text-3xl font-bold ${themeClasses.gradient} bg-clip-text text-transparent`} mb-1`}>0</div>
              ...
              <div className={`text-center p-4 ${themeClasses.cardBackground} backdrop-blur-sm rounded-xl border ${themeClasses.border}`}>
                <div className={`${theme === 'aloof' ? 'aloof-stat-number text-3xl font-bold' : `text-3xl font-bold ${themeClasses.gradient} bg-clip-text text-transparent`} mb-1`}>50+</div>
        ...
        {/* Bottom Fade */}
        <div className="absolute bottom-0 left-0 right-0 h-32 opacity-80" style={{ background: `linear-gradient(to top, ${theme === 'light' ? '#fef3c7' : theme === 'dark' ? '#1a1625' : 'transparent'}, transparent)` }}></div>
      </section>
      ...
      <section className={`py-32 ${themeClasses.pageBackground} relative transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative items-stretch">
            {/* Connecting Line */}
            <div className={`hidden md:block absolute top-16 left-[8%] right-[8%] h-0.5 ${themeClasses.gradient} opacity-20`}></div>
            
            {/* Step 1 - Light Theme */}
            <div className="relative group h-full">
              <div className={`h-full flex flex-col ${themeClasses.cardBackground} rounded-2xl p-8 shadow-lg hover:shadow-xl dark:shadow-soft dark:hover:shadow-medium transition-all duration-300 border-2 ${themeClasses.border} ${themeClasses.cardHover} hover:-translate-y-2`}>
                <div className={`w-16 h-16 ${themeClasses.gradient} rounded-2xl flex items-center justify-center text-white text-2xl font-bold mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
                  01
                </div>
                <h3 className={`text-2xl font-bold ${themeClasses.textPrimary} mb-4`}>
                  Upload Your Data
                </h3>
                <p className={`${themeClasses.textSecondary} leading-relaxed mb-6 flex-1`}>
